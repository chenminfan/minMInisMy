            ...
            <div className="portfolio-carousel">
              <Carousel carouselName="prodCarousel" carouselPre={IS_IMAGES.length > 1} carouselNext={IS_IMAGES.length > 1}>
                <div className="carousel-inner h-100">
                  {PORTFOLIO_BASE_ITEM?.imageUrl && <div className={`carousel-item h-100 active ${PORTFOLIO_BASE_ITEM?.imageUrl.includes('page') && 'carousel-item-page'}`} data-bs-interval="10000">
                  ...
                  {IS_IMAGES.length > 1 && (<>
                    {PORTFOLIO_BASE_ITEM?.imageInfo?.map((item, index) => (
                      <div className={`carousel-item h-100 ${(item.includes('page') || item.includes('-m-')) && 'item-page'}`} key={`${item}_${index}`} data-bs-interval="10000">
                        <div className="img-box">
